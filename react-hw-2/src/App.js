...
class App extends Component {
  ...
  render() {
    ...
    return (
      <>
        <Navbar cart={this.state.cart} products={products} favorites={this.state.favorites} total={this.state.total} />
        <div className='container'>
          <Items products={products} onClick={this.handleOpenModal} handleFav={this.handleFav} removeFav={this.removeFav} favorites={this.state.favorites} />
        </div>
